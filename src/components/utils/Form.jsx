...
export default function Form() {
  return (
   ...
   <form novalidate="" className="container w-full max-w-xl p-8 mx-auto space-y-6 rounded-md shadow bg-white/5">
       <h2 className="w-full text-3xl text-white font-bold leadi">Contact us</h2>
       <div>
       ...
       <div>
           <button type="submit" className="w-full px-4 py-2 font-bold rounded shadow focus:outline-none focus:ring hover:ring focus:ri bg-violet-400 focus:ri hover:ri text-gray-900">Send</button>
       </div>
   </form>
</section>
</>
